...
const PROFILE_PERMISSION_OPTIONS = [
    ...
    { code: PermissionsList.ORDERS_TIMER_USE, label: 'Timer: start / pause / resume (assigned orders)' },
    { code: PermissionsList.ORDERS_TIMER_STOP, label: 'Timer: stop (line or legacy order)' },
    { code: PermissionsList.ORDERS_TIMERS_GLOBAL_READ, label: 'Timers: all orders export / history list' },
    { code: PermissionsList.ORDERS_TIMERS_HISTORY_READ, label: 'Timers: sessions list on order page' },
    { code: PermissionsList.ORDERS_TIMER_ADJUST, label: 'Timers: manual duration correction' },
    { code: PermissionsList.ORDERS_TIMER_CLEAR_ALL, label: 'Timers: clear all data for order (manager/admin)' },
